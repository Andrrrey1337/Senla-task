...
@WebMvcTest(controllers = TariffController.class, excludeAutoConfiguration = SecurityAutoConfiguration.class)
...
class TariffControllerTest {
    ...
    @MockitoBean
    private JwtService jwtService; // Нужен для загрузки контекста
    ...
    @Test
    @DisplayName("PUT /api/tariffs/{id} - Обновление тарифа")
    void updateTariff_Success() throws Exception {
        ...
        mockMvc.perform(put("/api/tariffs/{id}", 1L)
                        .contentType(MediaType.APPLICATION_JSON)
